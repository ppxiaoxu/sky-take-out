...
public class OrderServiceImpl implements OrderService {
    ...
    private void checkOutOfRange(String address){
        ...
        //用户经纬度坐标
        String userLngLat = latitude + "," + longitude;
        ...
        if(jsonObject.getInteger("status") != 0){
            throw new OrderBusinessException("配送地址超出配送范围");
        }
...
//        }
        ...
        // WebSocket推送浏览器消息 type orderId content
        Map<String, Object> map = new HashMap<>();
        map.put("type", 1); // 来电提醒 2催单
        map.put("orderId", Long.parseLong(ordersPaymentDTO.getOrderNumber()));
...
//            }
    ...
    public void reminder(Long id) {
        ...
        Map map = new HashMap();
        map.put("type", 2);//1表示来单提醒，2表示用户订单催单
        map.put("orderId", id);
        map.put("content", "订单号：" + ordersDB.getNumber());
        String json = JSON.toJSONString(map);
        //通过websocket向客户端浏览器推送消息
